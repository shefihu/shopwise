      ...
      <div className="bg-gray-200">
        <div className="container  mx-auto py-9 md:py-12 lg:py-24">
          <div className="relative  mx-4">
            ...
            <button className="absolute bottom-0 sm:hidden  text-gray-300 bg-gray-400 py-4 text-base font-medium  mt-8 flex justify-center items-center w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">
              Explore
            </button>
          </div>
        </div>
