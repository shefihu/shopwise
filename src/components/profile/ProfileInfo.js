...
//svgs
import EmptyUserImage from "../../assets/svg/user.svg";
import { AddToProfileInfo } from "../../firebase/config";
...
function ProfileInfo() {
  ...
  return (
    <>
      <div className="w-full pb-10 pt-6  rounded-3xl bg-white">
        <div className="text-xl   mx-6 font-bold flex justify-between items-center ">
          <h2>Profile Info</h2>
          <span
            onClick={() => {
              setOpenModal(true);
        ...
        <div className="flex flex-col gap-6 my-4 items-center justify-center">
          <div className="rounded-full relative w-20 h-20 bg-muted flex items-center justify-center">
            {currentUser.currentUser?.photoURL !== null ? (
              ...
              <img src={EmptyUserImage} alt="No profile " height="100" />
            )}
          </div>
      ...
      {openModal && (
        <Modal2>
          <>
            <div className="  flex flex-col justify-center   w-[92%] md:w-[32rem] ">
