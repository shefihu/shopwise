...
function ResetPassword() {
  ...
  const openDropdown = () => {
    ...
    tIn.current = gsap
      .timeline()
      .fromTo(
        ResetPasswordButton.current,
        { height: "0%", opacity: 0 },
        { height: "100%", opacity: 1, duration: 1, ease: "expo.out" }
      )
      .fromTo(
        q("form"),
        { height: "0%", opacity: 0 },
  ...
  const closeDropdown = () => {
    tIn.current = gsap
      ...
      .to(
        ResetPasswordButton.current,
        { height: "0%", opacity: 0, duration: 1, ease: "expo.out" },
        "<20%"
      );
    setisOpen(false);
  };
  ...
  return (
    <>
      <button
        className="w-full bg-white text-green-300 py-6 rounded-3xl font-bold text-2xl text-center"
      ...
      <div
        className=" w-full mt-6 px-10  opacity-5 bg-white rounded-3xl pt-4 "
          ...
          {({
            ...
            <form onSubmit={handleSubmit} className="flex-col flex">
              ...
              <div className="w-full flex justify-end">
                <button
                  type="submit"
                  className="btn mt-8 flex justify-center items-center gap-2"
