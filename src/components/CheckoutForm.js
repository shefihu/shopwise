...
const StripeCheckoutForm = () => {
  return (
    <div>
      <section className="bg-white px-4 py-4 rounded-3xl">
        <div className="flex  flex-row items-center gap-4 overflow-x-auto overflow-y-hidden w-full sm:w-full flex-nowrap lg:px-0">
          <label className="relative">
            <input
              ...
              checked
            />
            <span className=" checkmark input flex flex-col justify-center items-center min-w-[8rem] h-14 lg:w-32 lg:h-14">
              <img src={VisaLogo} alt="Buy Airtime" width="60" />
            </span>
          </label>
          <label className="relative">
            <input
            ...
            />
            <span className=" checkmark input flex flex-col justify-center items-center min-w-[8rem] h-14 lg:w-32 lg:h-14">
              <img src={MastercardLogo} alt="Buy Airtime" width="60" />
            </span>
          </label>
          <label className="relative">
            <input
            ...
            />
            <span className=" checkmark input flex flex-col justify-center items-center min-w-[8rem] h-14 lg:w-32 lg:h-14">
              <img src={PaypalLogo} alt="Buy Airtime" width="60" />
            </span>
          </label>
        </div>
