...
const Modal2 = () => {
  ...
  return (
    <div>
      {" "}
      <div className="bg-slate-800 lg:pt-40 lg:pb-40 py-9">
        <div className="bg-white container mx-auto lg:max-w-[624px] w-full md:max-w-[720px] max-w-[343px] pb-14">
          <div className="flex justify-end items-end px-6 lg:py-6 md:py-6 py-3">
            <svg
          ...
          <div className="flex justify-center items-center lg:px-14 md:px-12 px-4">
            <img
              className="lg:block md:hidden hidden w-full object-fill object-center"
              src="https://tuk-cdn.s3.amazonaws.com/can-uploader/pexels-karolina-grabowska-5650050%201.png"
              alt="black-friday-sale"
            />
            <img
              className="md:block lg:hidden hidden w-full object-fill object-center"
            ...
            />
            <img
              className="lg:hidden md:hidden block w-full object-fill object-center"
              src="https://tuk-cdn.s3.amazonaws.com/can-uploader/12pro.png"
              alt="black-friday-sale-12-pro"
            />
          </div>
          <div className="mt-8">
            <p className="lg:text-4xl text-center font-semibold lg:leading-9 text-gray-800 lg:mb-4 md:mb-2 md:text-3xl text-2xl md:leading-loose lg:mb-3 md:mb-1 mb-2">
              Get 20% Discount
            </p>
          ...
          <div className="flex justify-center items-center mt-8 lg:px-0 md:px-12 px-4">
            <input
              className="text-gray-600 leading-none text-base py-4 pl-4 lg:max-w-[400px] lg:w-full md:w-full w-full bg-white border border-gray-300 outline-0"
              type="text"
              placeholder="Email Address"
            />
          </div>
          <div className="flex justify-center items-center mt-4 w-full lg:px-0 md:px-12 px-4">
            <button className="text-base font-medium text-center leading-none text-white py-4 lg:max-w-[400px] lg:w-full md:w-full w-full bg-gray-800 hover:bg-gray-700 transition duration-300 ease-in-out">
              Get discount
            </button>
          </div>
        </div>
